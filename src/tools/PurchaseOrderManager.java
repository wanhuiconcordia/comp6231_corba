...
public class PurchaseOrderManager {
	public HashMap<String, ItemImpl> itemsMap;
	...
	private void loadItems(){
		...
		if(root != null){
			...
			for(Element subElem: nodes){
				...
				itemsMap.put(productType, new ItemImpl(manufacturerName, productType, unitPrice, quantity));
			}
		}
	}
	...
	public void saveItems()
	{
		...
		for(ItemImpl item: itemsMap.values()){
